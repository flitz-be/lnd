...
type Config struct {
	...
	MaxCallSizeBytes int `long:"max_call_size_bytes" description:"The maximum size of a transaction in bytes for the etcd gRPC client."`
...
func (c *Config) CloneWithSubNamespace(subNamespace string) *Config {
	...
	return &Config{
		...
		MaxCallSizeBytes:   c.MaxCallSizeBytes,
	}
}
